...
import { kNoCard, isSuit, isRank, isCard, isNoCard, isTrickCard, isTrick } from './cards.js';
...
describe('cards_ts', (): void => {
    ...
    it('all_ranks and all_suits are correct', async() => {
        expect(all_ranks).to.deep.equal(['2', '3', '4', '5', '6', '7', '8', '9', '10', 'jack', 'queen', 'king', 'ace']);
        expect(all_suits).to.deep.equal(['clubs', 'diamonds', 'spades', 'hearts']);
    });
    ...
    it('isSuit is correct', async() => {
        expect(isSuit('clubs')).to.be.true;
        expect(isSuit('diamonds')).to.be.true;
        expect(isSuit('spades')).to.be.true;
        expect(isSuit('hearts')).to.be.true;

        expect(isSuit('club')).to.be.false;
        expect(isSuit('diamond')).to.be.false;
        expect(isSuit('spade')).to.be.false;
        expect(isSuit('heart')).to.be.false;

        expect(isSuit('')).to.be.false;
        expect(isSuit('foo')).to.be.false;
        expect(isSuit('bar')).to.be.false;
        expect(isSuit('baz')).to.be.false;
    });

    it('isRank is correct', async() => {
        expect(isRank('2')).to.be.true;
        expect(isRank('3')).to.be.true;
        expect(isRank('4')).to.be.true;
        expect(isRank('5')).to.be.true;
        expect(isRank('6')).to.be.true;
        expect(isRank('7')).to.be.true;
        expect(isRank('8')).to.be.true;
        expect(isRank('9')).to.be.true;
        expect(isRank('10')).to.be.true;
        expect(isRank('jack')).to.be.true;
        expect(isRank('queen')).to.be.true;
        expect(isRank('king')).to.be.true;
        expect(isRank('ace')).to.be.true;

        expect(isRank('1')).to.be.false;
        expect(isRank('11')).to.be.false;
        expect(isRank('12')).to.be.false;
        expect(isRank('13')).to.be.false;

        expect(isRank('')).to.be.false;
        expect(isRank('foo')).to.be.false;
        expect(isRank('bar')).to.be.false;
        expect(isRank('baz')).to.be.false;
    });
    ...
    it('itTrick is correct', function() {
        ...
        expect(isTrick([kNoCard, kNoCard, kNoCard, {rank: '2', suit: 'spades'}])).to.be.true;
        expect(isTrick([kNoCard, kNoCard, {rank: '2', suit: 'spades'}, {rank: '2', suit: 'spades'}])).to.be.true;
        expect(isTrick([kNoCard, {rank: '2', suit: 'spades'}, {rank: '2', suit: 'spades'}, {rank: '2', suit: 'spades'}])).to.be.true;
        expect(isTrick([{rank: '2', suit: 'spades'}, {rank: '2', suit: 'spades'}, {rank: '2', suit: 'spades'}, {rank: '2', suit: 'spades'}])).to.be.true;
        expect(isTrick([kNoCard, {rank: '2', suit: 'spades'}, kNoCard, kNoCard])).to.be.true;
